...
//         _reconnectWebSocket(); // Attempt to reconnect when closed
//       });
//     } catch (e, stackTrace) {
//       print("WebSocket initialization error: $e\n$stackTrace");
//       _reconnectWebSocket(); // Attempt to reconnect on failure
//     }
//   }

//   Future<void> _reconnectWebSocket() async {
//     _reconnectAttempts++;
//     int delay = min(30, pow(2, _reconnectAttempts)).toInt();
//     print("Attempting to reconnect in $delay seconds...");
//     await Future.delayed(Duration(seconds: delay));
//     _initializeCallingWebSocket(AuthService().getCurrentUserID()!);
//   }
